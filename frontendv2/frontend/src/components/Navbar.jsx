...
const Navbar = () => {
  ...
  return (
    <nav
      className={`sticky top-0 z-50 bg-[#ffffff] transition-all duration-300 ${scrolled ? "shadow-lg py-2" : "shadow-md py-3"
        }`}
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 lg:px-6">
        ...
        <div className="hidden lg:flex items-center gap-1 xl:gap-2">
          <NavLink
            ...
            className={({ isActive }) =>
              `px-3 xl:px-4 py-2 text-sm font-medium rounded-lg transition-all ${isActive
          ...
          >
            <button
              ...
              className={`px-3 xl:px-4 py-2 text-sm font-medium rounded-lg transition-all flex items-center gap-1 ${infoOpen || isInfoPageActive
                ? "text-[#fe7245] bg-white/10"
                : "text-[#0a214f] hover:text-[#fe7245] hover:bg-white/5"
                }`}
            >
          ...
          {isAuthenticated ? (
            <>
              ...
              <div className="relative ml-2" ref={profileRef}>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-[#0a214f] max-w-[120px] truncate">
                    {user?.name || user?.email}
                  </span>
                  <svg
                    className={`w-4 h-4 text-[#0a214f] transition-transform ${profileOpen ? "rotate-180" : ""
                      }`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
            ...
            <>
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center px-3 xl:px-4 py-2 text-sm font-medium rounded-lg transition-all ${isActive
                    ? "text-[#fe7245] bg-white/10"
                    : "text-[#0a214f] hover:text-[#fe7245] hover:bg-white/5"
                  }`
                }
      ...
      >
        <div className="px-4 pt-4 pb-6 space-y-2 bg-[#0a214f] border-t border-white/10">
          <NavLink
            ...
            onClick={() => setOpen(false)}
            className={({ isActive }) =>
              `block px-4 py-3 text-sm font-medium rounded-lg transition-all ${isActive
                ? "text-[#fe7245] bg-white/10"
          ...
          >
            ...
            <button
              onClick={() => setInfoOpen(!infoOpen)}
              className={`w-full flex items-center justify-between px-4 py-3 text-sm font-medium rounded-lg transition-all ${infoOpen || isInfoPageActive
                ? "text-[#fe7245] bg-white/10"
                : "text-white hover:text-[#fe7245] hover:bg-white/5"
                }`}
            >

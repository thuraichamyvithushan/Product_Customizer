    ...
    <div className="relative">
      ...
      <div className="relative z-10">
            ...
            <div className="w-full">
              <div className={`mb-6 transition-all duration-700 ${
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 backdrop-blur-md bg-white/10 rounded-full border border-white/20">
                  ...
                  <span className="text-sm text-white/90 font-medium">{post.date}</span>
              ...
              <p className={`text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed font-light transition-all duration-700 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className={`mb-12 transition-all duration-700 ease-out ${
            ...
            <div className="relative group overflow-hidden rounded-3xl shadow-2xl">
              ...
              <img 
                src={post.image} 
                alt={post.title}
                className="relative z-10 w-full h-[400px] md:h-[500px] lg:h-[600px] object-cover rounded-3xl transition-transform duration-700 group-hover:scale-105"
              />
              ...
              {post.content.map((section, index) => {
                if (section.type === "paragraph") {
                  ...
                  return (
                    <div 
                      key={index} 
                      className={`mt-16 mb-8 first:mt-0 transition-all duration-700 ${
                        contentVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                      }`}
                      style={{ transitionDelay: `${600 + (index * 100)}ms` }}
                    >
                      <div className="flex items-center gap-4 mb-4">
                        <div className="w-1.5 h-12 bg-gradient-to-b from-[#fe7245] via-[#ff855f] to-[#0a214f] rounded-full shadow-lg"></div>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0a214f] leading-tight">
                          {section.text}
                        </h2>
                      </div>
                      <div className="h-1 w-32 bg-gradient-to-r from-[#fe7245] via-[#ff855f] to-transparent rounded-full"></div>
                    </div>
                  );
                    ...
                    >
                      <ul className="space-y-4">
                        {section.items.map((item, itemIndex) => (
                          ...
                          >
                            <div className="flex-shrink-0 w-6 h-6 rounded-lg bg-gradient-to-br from-[#fe7245] to-[#ff855f] flex items-center justify-center mt-1 shadow-md group-hover/item:scale-110 group-hover/item:rotate-12 transition-all duration-300">
                              <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" />
                              </svg>
                            </div>
                            <span className="text-lg md:text-xl text-gray-700 leading-relaxed font-light flex-1 pt-0.5">
                              {item}
                            </span>
                          </li>
                        ))}
          ...
          <div className={`mt-12 mb-8 transition-all duration-700 ${
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-[#0a214f]">{post.author}</p>
                    <p className="text-sm text-gray-600">{post.date}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-sm text-gray-600 font-medium">Share:</span>
                  <button className="w-10 h-10 rounded-xl bg-white/80 border border-white/40 flex items-center justify-center hover:bg-[#0a214f] hover:text-white hover:scale-110 transition-all duration-300">
                ...
                {prevPost ? (
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                      <div className="flex-shrink-0 w-14 h-14 rounded-xl bg-gradient-to-br from-[#0a214f] to-[#1a3a6b] flex items-center justify-center group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-lg">
                        <svg className="w-7 h-7 text-white group-hover:-translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" />
                        </svg>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs text-gray-500 mb-2 font-semibold uppercase tracking-wide">Previous Article</p>
                        <p className="text-lg font-bold text-gray-900 group-hover:text-[#fe7245] transition-colors duration-300 line-clamp-2">
                          {prevPost.title}
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                      <div className="flex-1 min-w-0 text-right">
                        <p className="text-xs text-gray-500 mb-2 font-semibold uppercase tracking-wide">Next Article</p>
                        <p className="text-lg font-bold text-gray-900 group-hover:text-[#fe7245] transition-colors duration-300 line-clamp-2">
                          {nextPost.title}
                        </p>
                      </div>

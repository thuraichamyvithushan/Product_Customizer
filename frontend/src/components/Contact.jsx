    ...
    <div className="min-h-screen pt-0 pb-6 md:pb-8 relative overflow-hidden" style={{
        ...
        <div className="relative w-full h-[400px] md:h-[500px] mb-12 overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 h-full flex items-center justify-center text-center">
            <div>
              ...
              <div className={`flex flex-wrap items-center justify-center gap-4 transition-all duration-700 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`} style={{ transitionDelay: '800ms' }}>
                <div className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-lg border-2 border-white/20 text-white font-semibold hover:bg-white/20 transition-all duration-300 hover:scale-105">
                  We're Here to Help
                </div>
              </div>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-12">
        <a
          ...
          className={`relative backdrop-blur-xl bg-white/60 rounded-xl p-4 border border-white/30 hover:bg-white/80 hover:border-[#fe7245] transition-all duration-500 hover:shadow-xl group transform hover:scale-[1.02] overflow-hidden ${
        ...
        >
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 group-hover:text-[#fe7245] transition-colors">Get a Machine For Your Site</h3>
        ...
        >
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 group-hover:text-[#fe7245] transition-colors">Customer Support</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        {/* Contact Form */}
        <div className={`relative backdrop-blur-xl bg-white/60 rounded-2xl shadow-xl p-6 md:p-8 border border-white/30 transform transition-all duration-700 hover:bg-white/80 hover:shadow-2xl overflow-hidden group ${
          isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"
        }`}
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 backdrop-blur-sm bg-white/80 border border-white/40 rounded-lg focus:ring-2 focus:ring-[#fe7245] focus:border-[#fe7245] transition-all outline-none hover:border-[#fe7245]/50 focus:scale-[1.01] transform"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                className="w-full px-4 py-3 backdrop-blur-sm bg-white/80 border border-white/40 rounded-lg focus:ring-2 focus:ring-[#fe7245] focus:border-[#fe7245] transition-all outline-none resize-none hover:border-[#fe7245]/50 focus:scale-[1.01] transform"
            ...
            <button
              ...
              className="w-full bg-[#fe7245] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[#ff855f] transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02] transform disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group"
            >
        ...
        <div className="space-y-6">
          {/* Address */}
          <div className={`relative backdrop-blur-xl bg-white/60 rounded-xl shadow-xl p-6 border border-white/30 transform transition-all duration-700 hover:bg-white/80 hover:shadow-2xl hover:scale-[1.02] group overflow-hidden ${
            isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"
          }`}
          style={{ transitionDelay: "400ms" }}
          >
            ...
            <div className="relative z-10 flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#0a214f] to-[#1a3a6b] flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-lg">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#fe7245] transition-colors">Address</h3>
          ...
          >
            ...
            <div className="relative z-10 flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#fe7245] transition-colors">Phone</h3>
                <a
                  href="https://wa.me/61431545553"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          >
            ...
            <div className="relative z-10 flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#fe7245] transition-colors">Email</h3>
                <a
          ...
          >
            ...
            <div className="relative z-10 flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#fe7245] transition-colors">Business hours</h3>
                <p className="text-gray-700">
                  Monday to Friday<br />
                  From 9 AM to 6 PM
                </p>

    ...
    <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-12">
        <a
          ...
          className={`p-4 bg-blue-50 rounded-lg border-2 border-blue-200 hover:border-[#0a214f] transition-all duration-300 hover:shadow-xl group transform hover:scale-[1.02] relative overflow-hidden ${
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        {/* Contact Form */}
        <div className={`bg-white rounded-xl shadow-lg p-6 md:p-8 border border-gray-200 transform transition-all duration-700 hover:shadow-xl ${
          isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"
        }`}
        ...
        <div className="space-y-6">
          {/* Address */}
          <div className={`bg-white rounded-xl shadow-lg p-6 border border-gray-200 transform transition-all duration-700 hover:shadow-xl hover:scale-[1.02] group ${
            isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"
          }`}
